...
const UserProfile = () => {
    ...
    return (
        <div className="my-5 mx-5">
            ...
            <input onChange={changeFun} type="text" value={email} name="email" className="form-control" placeholder="Enter Your Email" />
            <label className="form-label">Adress</label>
            <input onChange={changeFun} type="text" value={address} name="address" className="form-control" placeholder="Enter Your Address" />
            <label className="form-label">Phone</label>
            <input onChange={changeFun} type="text" value={phone} name="phone" className="form-control" placeholder="Enter Your Phone" />
