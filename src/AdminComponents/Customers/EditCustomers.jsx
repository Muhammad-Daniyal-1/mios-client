      ...
      <section className="area-login" style={{ marginTop: '0px' }}>
        <div className="login">
          ...
          <form method='post'>
            ...
            <center>
              {role === "dropshipper" && <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}><input checked={dropShipperStatus} style={{ marginRight: '20px', marginTop: '0px' }} type="checkBox" name="dropShipperStatus" id='dropShipperStatus' placeholder="dropShipperStatus" onChange={onChange} required /><p>  Approved</p></span>}
            </center>
